...
# Versão 1.0 - ASP.NETCore Runtime x86                                             #
####################################################################################
...
$PathNet = "C:\Program Files (x86)\dotnet\shared\Microsoft.AspNetCore.App"
...
{
    .\dotnet-core-uninstall remove $version --x86 --aspnet-runtime --force --yes
